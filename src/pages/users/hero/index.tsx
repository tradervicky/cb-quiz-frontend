  ...
  return (
    <div className='flex flex-col sm:flex-row px-8 sm:px-20 items-center bg-primary'>
        <div className='w-full sm:w-[40%]'>
            <h1 className='text-btn text-3xl sm:text-5xl font-bold tracking-wider leading-tight'>Master your Skills with quizApp</h1>
        ...
        <div className='w-full sm:w-[60%] mix-blend-multiply'>
